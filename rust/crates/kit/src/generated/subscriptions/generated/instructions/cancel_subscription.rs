...
impl<'a, 'b> CancelSubscriptionCpiBuilder<'a, 'b> {
    ...
    pub fn subscriber(
        &mut self,
        subscriber: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn subscription_pda(
        &mut self,
        subscription_pda: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
